...
*** TIANCHI will use octant for cluster inspection. Each cluster will be installed one octant instance. Now octant needs the kubeconfig file, while TIANCHI can only pass the kubeconfig content. So we need to modify octant to accept the kubeconfig content. ***
